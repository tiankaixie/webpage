...
This is an Astro-based personal website using the AntfuStyle theme. It presents Tiankai Xie's homepage, writing, and changelog in a monochrome editorial style.
...
- `src/components/` - Reusable UI components organized by category
  ...
  - `widgets/` - Small interactive components (ThemeSwitch, ToTopButton, etc.)
...
- Streams use JSON data files in their content directory
